...
description: Orchestrate building a brand-new feature end to end â€” research, plan, TDD, review, gated commit. Wrapper that kicks off the orch-add-feature skill.
---
