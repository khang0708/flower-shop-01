...
4. **Task Type Routing**:
   ...
   | **Fullstack** | Contains both frontend and backend | Codex âˆ¥ Antigravity parallel |
...
#### Route A: Frontend/UI/Styles â†’ Antigravity
...
2. **Dirty Prototype Refactoring** â€“ Codex/Antigravity output treated as draft, must refactor
3. **Trust Rules** â€“ Backend follows Codex, Frontend follows Antigravity
