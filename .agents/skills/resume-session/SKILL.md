...
Note this during the briefing â€” "WARNING: `path/to/file.ts` referenced in session but not found on disk."

**Session file is from more than 7 days ago:**
Note the gap â€” "WARNING: This session is from N days ago (threshold: 7 days). Things may have changed." â€” then proceed normally.
...
WHAT NOT TO RETRY:
FAIL: Next-Auth â€” conflicts with custom Prisma adapter, threw adapter error on every request
FAIL: localStorage for JWT â€” causes SSR hydration mismatch, incompatible with Next.js
