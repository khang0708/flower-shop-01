...
description: Orchestrate fixing a bug â€” reproduce it as a failing regression test, fix to green, review, gated commit. Wrapper for the orch-fix-defect skill.
---
