...
---
name: {skill-name}
description: "Use when working in {repo-name}, especially before editing its common modules, placing tests, naming branches, or writing commits â€” conventions measured from git history"
metadata:
  version: "1.0.0"
