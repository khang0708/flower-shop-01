...
Interact with Jira tickets directly from your workflow â€” fetch tickets, analyze requirements, add comments, and transition status.
...
1. **Get & Analyze** â€” Fetch a Jira ticket and extract requirements, acceptance criteria, test scenarios, and dependencies
2. **Comment** â€” Add structured progress updates to a ticket
3. **Transition** â€” Move a ticket through workflow states (To Do â†’ In Progress â†’ Done)
4. **Search** â€” Find issues using JQL queries
...
**Option A â€” MCP Server (recommended):**
...
- **MCP config:** `mcp-configs/mcp-servers.json` â†’ `jira`
